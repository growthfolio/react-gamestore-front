...
import { ShoppingCart, Heart, Star, User, ShareNetwork, WhatsappLogo, TwitterLogo, Link as LinkIcon, Warning } from '@phosphor-icons/react';
          ...
          <div className="space-y-4">
            <div className="card-gaming overflow-hidden aspect-video flex items-center justify-center relative">
              {produto.imagens && produto.imagens.length > 0 ? (
                <img src={produto.imagens[imagemAtual]} alt={produto.nome} className="w-full h-full object-cover" />
              ) : (
